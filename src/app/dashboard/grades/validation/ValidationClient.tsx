...
import { returnReportCardsToTeacher, approveReportCards } from "../actions";
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {approved && (
                          <Link
                            href={`/dashboard/grades/validation/impression?classId=${s.classId}&termId=${s.termId}&evaluationId=${s.evaluationId}`}
