    ...
    <div className="space-y-6 max-w-6xl pb-12">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-100 pb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link 
            href={`/dashboard/grades/report-card?studentId=${student.id}`}
          ...
          <Link 
            href={`/dashboard/payments/invoice?studentId=${student.id}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
              <div className="border-b border-gray-100 px-6 py-4 flex justify-between items-center">
                ...
                <Link href={`/dashboard/payments/invoice?studentId=${student.id}`} className="text-xs font-bold text-blue-600 hover:text-blue-700">
                  Créer
                </Link>
              </div>
              <div className="p-6">
